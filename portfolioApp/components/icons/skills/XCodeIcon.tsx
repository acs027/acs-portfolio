...
export function XCodeIcon(props: { size?: number }) {
  return (
    <Svg
      width={props.size || 24}
...
<LinearGradient id="xcode-original-a" gradientUnits="userSpaceOnUse" x1="63.947" y1="114.165" x2="63.947" y2="13.784">
  ...
  <Stop offset="1" stopColor="#00c3f2"></Stop>
  </LinearGradient>
...
<LinearGradient id="xcode-original-b" gradientUnits="userSpaceOnUse" x1="94.037" y1="79.666" x2="94.037" y2="72.184">
  <Stop offset="0" stopColor="#1492e7"></Stop><Stop offset="1" stopColor="#dbedfb"></Stop></LinearGradient>
...
<LinearGradient id="xcode-original-c" gradientUnits="userSpaceOnUse" x1="89.042" y1="79.666" x2="89.042" y2="72.184">
  <Stop offset="0" stopColor="#1492e7"></Stop><Stop offset="1" stopColor="#dbedfb"></Stop>
  </LinearGradient>
...
<Stop offset="1" stopColor="#dbedfb"></Stop>
</LinearGradient>
...
<LinearGradient id="xcode-original-e" gradientUnits="userSpaceOnUse" x1="58.952" y1="79.666" x2="58.952" y2="72.184">
  <Stop offset="0" stopColor="#1492e7"></Stop>
  <Stop offset="1" stopColor="#dbedfb"></Stop>
</LinearGradient><Path d="M58.8 72.2h.5s-.2 1.9-.2 3.9c0 1.8.2 3.6.2 3.6h-.5s-.2-1.8-.2-3.6c0-2 .2-3.9.2-3.9z" fill="url(#xcode-original-e)"></Path>
<LinearGradient id="xcode-original-f" gradientUnits="userSpaceOnUse" x1="53.958" y1="79.666" x2="53.958" y2="72.184"><Stop offset="0" stopColor="#1492e7"></Stop><Stop offset="1" stopColor="#dbedfb"></Stop></LinearGradient>
<Path d="M54 72.2h.5s-.5 1.9-.5 3.9c0 1.8.5 3.6.5 3.6H54s-.5-1.8-.5-3.6c0-2 .5-3.9.5-3.9z" fill="url(#xcode-original-f)"></Path>
<LinearGradient id="xcode-original-g" gradientUnits="userSpaceOnUse" x1="48.963" y1="79.666" x2="48.963" y2="72.184"><Stop offset="0" stopColor="#1492e7"></Stop>
<Stop offset="1" stopColor="#dbedfb"></Stop></LinearGradient>
<Path d="M49.1 72.2h.5s-.7 1.9-.7 3.9c0 1.8.7 3.6.7 3.6h-.5s-.7-1.8-.7-3.6c0-2 .7-3.9.7-3.9z" fill="url(#xcode-original-g)"></Path>
<LinearGradient id="xcode-original-h" gradientUnits="userSpaceOnUse" x1="43.968" y1="79.666" x2="43.968" y2="72.184"><Stop offset="0" stopColor="#1492e7"></Stop><Stop offset="1" stopColor="#dbedfb"></Stop></LinearGradient>
<Path d="M44.2 72.2h.5s-1 1.6-1 3.9c0 2 1 3.6 1 3.6h-.5s-1-1.6-1-3.6c0-2.3 1-3.9 1-3.9z" fill="url(#xcode-original-h)"></Path>
<LinearGradient id="xcode-original-i" gradientUnits="userSpaceOnUse" x1="38.852" y1="79.666" x2="38.852" y2="72.184"><Stop offset="0" stopColor="#1492e7"></Stop><Stop offset="1" stopColor="#dbedfb"></Stop></LinearGradient>
...
<LinearGradient id="xcode-original-j" gradientUnits="userSpaceOnUse" x1="33.857" y1="79.666" x2="33.857" y2="72.184"><Stop offset="0" stopColor="#1492e7"></Stop>
<Stop offset="1" stopColor="#dbedfb"></Stop></LinearGradient>
...
<LinearGradient id="xcode-original-k" gradientUnits="userSpaceOnUse" x1="73.58" y1="94.25" x2="73.58" y2="32.642">
  ...
  <Stop offset="1" stopColor="#00b5ef"></Stop></LinearGradient>
  ...
  <LinearGradient id="xcode-original-l" gradientUnits="userSpaceOnUse" x1="87.464" y1="93.978" x2="54.081" y2="36.156"><Stop offset="0" stopColor="#2b90e7"></Stop>
  <Stop offset="1" stopColor="#00b6ef"></Stop></LinearGradient><Path d="M54.2 36.7L87 93.6l.2.1.2.1.2.1-33.4-57.8v.6z" fill="url(#xcode-original-l)"></Path>
  <LinearGradient id="xcode-original-m" gradientUnits="userSpaceOnUse" x1="89.073" y1="94.327" x2="54.583" y2="34.589"><Stop offset="0" stopColor="#3795ea"></Stop>
  <Stop offset="1" stopColor="#49c4f2"></Stop></LinearGradient><Path d="M54.5 34.8l34.3 59.4h.4L54.7 34.5l-.1.2-.1.1z" fill="url(#xcode-original-m)"></Path>
  <LinearGradient id="xcode-original-n" gradientUnits="userSpaceOnUse" x1="91.026" y1="93.735" x2="56.072" y2="33.193"><Stop offset="0" stopColor="#3696ea"></Stop>
  <Stop offset="1" stopColor="#90d9f6"></Stop></LinearGradient><Path d="M55.9 33.3l35 60.5.3-.2-35-60.5-.3.2z" fill="url(#xcode-original-n)"></Path>
  <LinearGradient id="xcode-original-o" gradientUnits="userSpaceOnUse" x1="92.582" y1="92.332" x2="58.065" y2="32.547"><Stop offset="0" stopColor="#3097ea"></Stop>
  <Stop offset="1" stopColor="#b5e5f9"></Stop></LinearGradient><Path d="M58.4 32.7L92.6 92l-.1.2-.1.2-34.5-59.8h.2l.3.1z" fill="url(#xcode-original-o)"></Path>
  <LinearGradient id="xcode-original-p" gradientUnits="userSpaceOnUse" x1="93.083" y1="90.686" x2="59.741" y2="32.936"><Stop offset="0" stopColor="#3a98ea"></Stop>
  <Stop offset="1" stopColor="#bce7fa"></Stop></LinearGradient><Path d="M60.2 33.3L93 90.1v.6L59.6 33l.2.1.2.1.2.1z" fill="url(#xcode-original-p)"></Path>
  ...
  <LinearGradient id="xcode-original-q" gradientUnits="userSpaceOnUse" x1="67.981" y1="61.226" x2="74.457" y2="57.487">
    <Stop offset="0" stopColor="#00a4ec"></Stop><Stop offset="1" stopColor="#b9dff6"></Stop></LinearGradient>
    ...
    <LinearGradient id="xcode-original-r" gradientUnits="userSpaceOnUse" x1="65.487" y1="56.906" x2="71.962" y2="53.167"><Stop offset="0" stopColor="#00a4ec"></Stop>
    <Stop offset="1" stopColor="#b9dff6"></Stop></LinearGradient><Path d="M71.9 53.1l.2.4s-1.9.6-3.5 1.6c-1.6.9-2.9 2.3-2.9 2.3l-.2-.4s1.3-1.4 2.9-2.3c1.6-1.1 3.5-1.6 3.5-1.6z" fill="url(#xcode-original-r)"></Path>
    <Path d="M67.4 49.8c1.3-.4 2.3-.6 2.3-.6l-.2-.4s-.9.1-1.9.5c-.6.2-.7.7-.2.5z" fill="#9dd4f7"></Path>
    <LinearGradient id="xcode-original-s" gradientUnits="userSpaceOnUse" x1="57.93" y1="43.819" x2="64.364" y2="40.105"><Stop offset="0" stopColor="#00b4ef"></Stop>
    <Stop offset="1" stopColor="#c3e9fa"></Stop></LinearGradient><Path d="M64.6 40.5l.2.4s-1.9-.5-4.1.7c-1.9 1.2-2.3 3.1-2.3 3.1l-.2-.4s.2-1.7 2.3-3c2.2-1.4 4.1-.8 4.1-.8z" fill="url(#xcode-original-s)"></Path>
    <LinearGradient id="xcode-original-t" gradientUnits="userSpaceOnUse" x1="55.424" y1="39.477" x2="61.9" y2="35.738"><Stop offset="0" stopColor="#00b4ef"></Stop><Stop offset="1" stopColor="#c3e9fa"></Stop></LinearGradient>
    ...
    <LinearGradient id="xcode-original-u" gradientUnits="userSpaceOnUse" x1="54.566" y1="94.401" x2="54.566" y2="32.794"><Stop offset="0" stopColor="#1285e7"></Stop>
    <Stop offset="1" stopColor="#00b5ef"></Stop>
    </LinearGradient><Path d="M54.4 71.3c8.8-15.2 19-32.9 19-32.9 1-1.7.4-4-1.3-5l-.1-.1c-1.7-1-4-.4-5 1.3 0 0-12 20.8-21.2 36.7h8.6zm-5.3 9.2c-4 7-6.9 12-6.9 12-1 1.7-3.2 2.3-5 1.3H37c-1.7-1-2.3-3.2-1.3-5 0 0 1.9-3.3 4.8-8.3h8.6z" fill="url(#xcode-original-u)"></Path>
    <LinearGradient id="xcode-original-v" gradientUnits="userSpaceOnUse" x1="40.681" y1="94.131" x2="74.064" y2="36.311"><Stop offset="0" stopColor="#3194e9"></Stop>
    <Stop offset="1" stopColor="#71cff4"></Stop></LinearGradient><Path d="M54.1 71.3L74 36.9v-.6s-11 19.1-20.2 35h.3zm-5.4 9.2l-7.6 13.2-.3.2-.3.1s3.4-5.9 7.8-13.5h.4z" fill="url(#xcode-original-v)"></Path>
    <LinearGradient id="xcode-original-w" gradientUnits="userSpaceOnUse" x1="39.063" y1="94.482" x2="73.557" y2="34.736"><Stop offset="0" stopColor="#5aa6ec"></Stop><Stop offset="1" stopColor="#a2def8"></Stop></LinearGradient>
    ...
    <LinearGradient id="xcode-original-x" gradientUnits="userSpaceOnUse" x1="37.118" y1="93.885" x2="72.072" y2="33.343"><Stop offset="0" stopColor="#66abee"></Stop>
    <Stop offset="1" stopColor="#bee8fa"></Stop></LinearGradient><Path d="M50.4 71.3c9.9-17.1 21.8-37.8 21.8-37.8l-.3-.2-22 38h.5zM45 80.6C40.6 88.3 37.3 94 37.3 94l-.3-.2s3.2-5.6 7.6-13.2c.2-.1.1-.1.4 0z" fill="url(#xcode-original-x)"></Path>
    <LinearGradient id="xcode-original-y" gradientUnits="userSpaceOnUse" x1="35.568" y1="92.482" x2="70.085" y2="32.697"><Stop offset="0" stopColor="#7bb6f0"></Stop><Stop offset="1" stopColor="#b1e3f9"></Stop>
    </LinearGradient><Path d="M48 71.3c9.9-17.1 22.2-38.5 22.2-38.5h-.4S57.5 54.1 47.6 71.3h.4zm-5.8 9.2c-4 6.9-6.7 11.6-6.7 11.6l.1.2.1.2s2.9-5 7-12h-.5z" fill="url(#xcode-original-y)"></Path>
    <LinearGradient id="xcode-original-z" gradientUnits="userSpaceOnUse" x1="35.056" y1="90.872" x2="68.415" y2="33.092"><Stop offset="0" stopColor="#5aa6ec"></Stop><Stop offset="1" stopColor="#afe3f9"></Stop></LinearGradient>
    ...
    <LinearGradient id="xcode-original-A" gradientUnits="userSpaceOnUse" x1="66.362" y1="35.689" x2="72.838" y2="39.428"><Stop offset="0" stopColor="#c1e7fa"></Stop>
    <Stop offset="1" stopColor="#89d4f5"></Stop></LinearGradient><Path d="M66 36.2l-.2.4s1.8-.9 4.2.4c2.2 1.2 2.3 3.3 2.3 3.3l.2-.4s.2-1.9-2.3-3.3-4.2-.4-4.2-.4z" fill="url(#xcode-original-A)"></Path>
    <LinearGradient id="xcode-original-B" gradientUnits="userSpaceOnUse" x1="63.856" y1="40.03" x2="70.332" y2="43.768"><Stop offset="0" stopColor="#c1e7fa"></Stop><Stop offset="1" stopColor="#89d4f5"></Stop></LinearGradient>
    ...
    <LinearGradient id="xcode-original-C" gradientUnits="userSpaceOnUse" x1="61.273" y1="44.505" x2="67.748" y2="48.243"><Stop offset="0" stopColor="#c1e7fa"></Stop>
    <Stop offset="1" stopColor="#89d4f5"></Stop></LinearGradient><Path d="M61.1 44.7l-.2.4s1.8-.1 3.8 1.1c1.8 1 2.7 2.6 2.7 2.6l.2-.4s-.9-1.6-2.7-2.6c-1.9-1.1-3.8-1.1-3.8-1.1z" fill="url(#xcode-original-C)"></Path>
    <LinearGradient id="xcode-original-D" gradientUnits="userSpaceOnUse" x1="58.761" y1="48.855" x2="65.236" y2="52.594"><Stop offset="0" stopColor="#b0dff8"></Stop><Stop offset="1" stopColor="#52bdf2"></Stop></LinearGradient>
    ...
    <LinearGradient id="xcode-original-E" gradientUnits="userSpaceOnUse" x1="56.25" y1="53.204" x2="62.727" y2="56.943"><Stop offset="0" stopColor="#b4def8"></Stop>
    <Stop offset="1" stopColor="#4eb5f0"></Stop></LinearGradient><Path d="M56.2 53.2l-.2.4s1.9.5 3.6 1.5c1.6.9 2.9 2.2 2.9 2.2l.2-.4s-1.3-1.3-2.9-2.2c-1.6-.9-3.6-1.5-3.6-1.5z" fill="url(#xcode-original-E)"></Path>
    <LinearGradient id="xcode-original-F" gradientUnits="userSpaceOnUse" x1="53.74" y1="57.553" x2="60.215" y2="61.291"><Stop offset="0" stopColor="#b4def8"></Stop><Stop offset="1" stopColor="#4eb5f0"></Stop></LinearGradient>
    ...
    <LinearGradient id="xcode-original-G" gradientUnits="userSpaceOnUse" x1="51.239" y1="61.886" x2="57.713" y2="65.624"><Stop offset="0" stopColor="#b5ddf8"></Stop><Stop offset="1" stopColor="#46aeee"></Stop></LinearGradient>
    <Path d="M51.1 62.1l.2-.4 6.5 3.7-.2.4-6.5-3.7z" fill="url(#xcode-original-G)"></Path><LinearGradient id="xcode-original-H" gradientUnits="userSpaceOnUse" x1="48.735" y1="66.22" x2="55.211" y2="69.959"><Stop offset="0" stopColor="#96cef4"></Stop>
    <Stop offset="1" stopColor="#46aaee"></Stop></LinearGradient><Path d="M48.7 66.4l.2-.4s1.6 1.2 3.3 2.1c1.6.9 3.2 1.6 3.2 1.6l-.2.3s-1.7-.7-3.3-1.6c-1.7-.9-3.2-2-3.2-2z" fill="url(#xcode-original-H)"></Path>
    <Path d="M47.1 71.3c-.5-.4-.8-.7-.8-.7l.2-.4s.6.5 1.4 1.1h-.8z" fill="#73b9f1"></Path><LinearGradient id="xcode-original-I" gradientUnits="userSpaceOnUse" x1="42.719" y1="80.135" x2="47.681" y2="83"><Stop offset="0" stopColor="#8fc1f2"></Stop>
    <Stop offset="1" stopColor="#3193ea"></Stop></LinearGradient><Path d="M43.2 80.5c.4.3.8.6 1.3.9 1.8 1 3.6.9 3.6.9l-.2.4s-1.8.1-3.6-.9c-.7-.4-1.3-.9-1.7-1.3h.6z" fill="url(#xcode-original-I)"></Path>
    <LinearGradient id="xcode-original-J" gradientUnits="userSpaceOnUse" x1="38.634" y1="83.717" x2="45.11" y2="87.456"><Stop offset="0" stopColor="#8fc1f2"></Stop>
    <Stop offset="1" stopColor="#3193ea"></Stop></LinearGradient><Path d="M38.9 83.3l.2-.4s.5 2 2.7 3.2c2 1.1 3.8.5 3.8.5l-.2.4s-1.6.7-3.8-.5c-2.3-1.3-2.7-3.2-2.7-3.2z" fill="url(#xcode-original-J)"></Path>
    ...
    <radialGradient id="xcode-original-M" cx="95.237" cy="25.132" r="16.181" fx="79.585" fy="25.974" gradientTransform="matrix(-.4494 .8933 -1.5457 -.7777 176.886 -40.4)" gradientUnits="userSpaceOnUse">
      ...
      <radialGradient id="xcode-original-N" cx="51.211" cy="114.953" r="7.901" fx="51.196" fy="117.292" gradientTransform="matrix(.8979 .4402 -.2506 .5111 34.032 33.662)" gradientUnits="userSpaceOnUse">
        ...
        <Stop offset=".351" stopColor="#787a83"></Stop><Stop offset=".47" stopColor="#71747d"></Stop><Stop offset=".591" stopColor="#777982"></Stop><Stop offset=".749" stopColor="#87898f"></Stop><Stop offset=".8" stopColor="#8e8f94"></Stop>
        <Stop offset=".849" stopColor="#3d3b42"></Stop><Stop offset=".9" stopColor="#606e84"></Stop></LinearGradient>
        ...
        <LinearGradient id="xcode-original-P" gradientUnits="userSpaceOnUse" x1="117.884" y1="29.257" x2="106.863" y2="14.364"><Stop offset=".27" stopColor="#262b33"></Stop>
        <Stop offset=".45" stopColor="#74747e"></Stop><Stop offset=".54" stopColor="#b0b0bc"></Stop><Stop offset=".73" stopColor="#74747e"></Stop></LinearGradient>
        ...
        <LinearGradient id="xcode-original-U" gradientUnits="userSpaceOnUse" x1="69.064" y1="16.837" x2="91.026" y2="16.837"><Stop offset="0" stopColor="#4a4d56"></Stop>
        <Stop offset="1" stopColor="#29292d"></Stop></LinearGradient>
        ...
        <Stop offset=".41" stopColor="#0c0a0b"></Stop></LinearGradient><Path d="M69.1 11.1c1.3-.5 3.1-.8 6.5-.6 4.2.2 9.5 1.8 11.7 3.8 1.1 1 1 .2-.2-1.1-3.1-3.6-7.8-4.4-13.9-4.5-.7-.1-3 1.2-4.1 2.4z" fill="url(#xcode-original-V)"></Path>
        <LinearGradient id="xcode-original-W" gradientUnits="userSpaceOnUse" x1="116.332" y1="34.756" x2="123.707" y2="21.982"><Stop offset="0" stopColor="#858997"></Stop><Stop offset=".23" stopColor="#244668"></Stop>
        <Stop offset=".282" stopColor="#1a3249"></Stop><Stop offset=".4" stopColor="#040506"></Stop><Stop offset=".464" stopColor="#313236"></Stop><Stop offset=".546" stopColor="#65656e"></Stop>
        <Stop offset=".607" stopColor="#868691"></Stop><Stop offset=".64" stopColor="#92929e"></Stop></LinearGradient>
